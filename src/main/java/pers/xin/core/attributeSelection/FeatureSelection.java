...
public class FeatureSelection extends Filter implements SupervisedFilter,
    ...
    /**
     * Signify that this batch of input to the pers.xin.filter is finished. If the pers.xin.filter
    ...
    public List<Integer> selectFeature(Instances data) throws Exception{
        ...
        m_NewBatch = true;
        return m_FSAlgorithm.getReductionList();
    }
